...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes() {
        ...
        UnitOfMeasure eachUom = eachUomOptional.orElseThrow(() -> getException("Expected UOM not found"));
        UnitOfMeasure tableSpoonUom = tableSpoonUomOptional.orElseThrow(() -> getException("Expected UOM not found"));
        UnitOfMeasure teaSpoonUom = teaSpoonUomOptional.orElseThrow(() -> getException("Expected UOM not found"));
        UnitOfMeasure dashUom = dashUomOptional.orElseThrow(() -> getException("Expected UOM not found"));
        UnitOfMeasure pintUom = pintUomOptional.orElseThrow(() -> getException("Expected UOM not found"));
        UnitOfMeasure cupsUom = cupsUomOptional.orElseThrow(() -> getException("Expected UOM not found"));

        Optional<Category> americanCategoryOptional = categoryRepository.findByDescription("American");
        Optional<Category> mexicanCategoryOptional = categoryRepository.findByDescription("Mexican");

        Category americanCategory = americanCategoryOptional.orElseThrow(
                                                () -> getException("Expected Category not found"));
        Category mexicanCategory = mexicanCategoryOptional.orElseThrow(
                                                () -> getException("Expected Category not found"));

        //        --create and add Guac Recipe
